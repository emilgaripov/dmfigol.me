...
![EIGRP classic mode metric calculation K5!=0](https://s3.us-east-2.amazonaws.com/media.dmfigol.me/eigrp-classic-metric-calculation-full.png){:height="45px"}  
If **K5=0**, then the formula changes to:  
![EIGRP classic mode metric calculation K5=0](https://s3.us-east-2.amazonaws.com/media.dmfigol.me/eigrp-classic-metric-calculation-k5-0.png){:height="45px"}   
![EIGRP classic mode bandwidth bw](https://s3.us-east-2.amazonaws.com/media.dmfigol.me/eigrp-metric-bandwidth.png){:height="45px"}  
![EIGRP classic mode delay](https://s3.us-east-2.amazonaws.com/media.dmfigol.me/eigrp-metric-delay.png){:height="40px"}
...
* Book [EIGRP for IP: Basic Operation and Configuration](https://www.amazon.com/EIGRP-Operation-Configuration-Addison-Wesley-Networking/dp/0201657732)
